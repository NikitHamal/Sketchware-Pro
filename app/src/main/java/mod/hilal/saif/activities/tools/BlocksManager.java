...
public class BlocksManager extends BaseAppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        // Undo / Redo
        MenuItem undoItem = menu.add(Menu.NONE, 10, 1, "↩ Undo");
        undoItem.setEnabled(!undoStack.isEmpty());
        MenuItem redoItem = menu.add(Menu.NONE, 11, 2, "↪ Redo");
        redoItem.setEnabled(!redoStack.isEmpty());
        // Other actions
        menu.add(Menu.NONE, 2, 3, "↑ Sort Palettes A→Z");
        menu.add(Menu.NONE, 3, 4, "↓ Sort Palettes Z→A");
        menu.add(Menu.NONE, 4, 5, "🗑 Remove Duplicate Blocks");
        menu.add(Menu.NONE, 5, 6, "✨ AI — Analyze & Suggest");
        menu.add(Menu.NONE, 6, 7, "🤖 AI — Create Blocks from Description");
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case 4:  removeDuplicateBlocksGlobal(); break; // pushUndo inside after confirm
            case 5:  launchGroqOrganizerGlobal(); break;
            case 6:  launchAiCreateBlocks(); break;
