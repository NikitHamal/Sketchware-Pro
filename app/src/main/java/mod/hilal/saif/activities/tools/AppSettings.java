...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        preferences.add(createPreference(R.drawable.ic_smart_toy, "API Configuration", "Configure Qwen AI API headers and parameters", openSettingsActivity(SettingsActivity.API_CONFIG_FRAGMENT)));
